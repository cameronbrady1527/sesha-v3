// // lib/docx.ts
// import { Document, Packer, Paragraph, TextRun, BorderStyle, HeadingLevel, ShadingType, AlignmentType } from "docx";
...
// export async function generateDocx({ headline, richContent, slug, version, author }: ExportOptions): Promise<Uint8Array> {
//   // Parse Lexical JSON
