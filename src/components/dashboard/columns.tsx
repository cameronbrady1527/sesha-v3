...
const columns: ColumnDef<DashboardRowData>[] = [
  /* --------------------------- Organization Name ------------------------- */
  {
    ...
    cell: ({ row }) => <div className="flex justify-center items-center w-full h-full text-center font-medium">{row.getValue<string>("organizationName")}</div>,
    size: 280,
  },
  ...
  /* ----------------------------- Total Runs ----------------------------- */
  {
    ...
    cell: ({ row }) => <span className="font-mono">{row.getValue<number>("totalRuns").toLocaleString()}</span>,
    size: 120,
  },
  ...
  /* ----------------------------- Total Cost ----------------------------- */
  {
    ...
    cell: ({ row }) => {
      ...
      return <span className="font-mono text-green-600">${typeof value === "number" && !isNaN(value) ? value.toFixed(2) : "0.00"}</span>;
    },
    size: 130,
  },
  ...
  /* ------------------------ Average Cost Per Run ------------------------ */
  {
    ...
    cell: ({ row }) => {
      ...
      return <span className="font-mono text-blue-600">${typeof value === "number" && !isNaN(value) ? value.toFixed(4) : "0.0000"}</span>;
    },
    size: 150,
  },
];
