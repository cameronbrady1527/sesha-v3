...
/* ==========================================================================*/
// presets.tsx — Preset management component (Aggregator context version)
/* ==========================================================================*/
// Purpose: Centralised UI for selecting, editing, and saving aggregator presets.
...
function PresetsManager({ presets = [] }: PresetsProps) {
  /* ------------------------ aggregator context bindings ---------------------- */
  const { preset, setPreset, canSavePreset } = useAggregator();
  ...
  useEffect(() => {
    console.log("[Aggregator Preset ctx]", preset);
  }, [preset]);
